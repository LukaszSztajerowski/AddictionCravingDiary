...
<jsp:include page="/viwes/appSideMenu.jsp"/>
...
<%--                <span class="font-weight-bold">Liczba objawów: ${numberOfRecipes}</span>--%>
<%--            </div>--%>
<%--            <div class="alert-item alert-light">--%>
<%--                <i class="far icon-calendar fa-calendar-alt"></i>--%>
<%--                <span class="font-weight-bold">Liczba punktów : ${numberOfPlans}</span>--%>
<%--            </div>--%>
<%--        </div>--%>
<%--    </div>--%>
...
<%--    </div>--%> // zamienic tą tabele na widok tabeli objawów głodu
</div>
</div>
</section>
